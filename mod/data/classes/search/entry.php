...
class entry extends \core_search\base_mod {
    ...
    protected function get_fields_for_entries($entry) {
        ...
        foreach ($contents as $content) {
            if (in_array($content->fieldtype, $validfields)) {
                $filteredcontents[] = $content;
            }
        }

        foreach ($filteredcontents as $content) {
            $content->priority = $fieldtypepriorities[$content->fieldtype];
        ...
        while ($contentqueue->valid()) {
            ...
            if ($content->fieldtype === 'multimenu' || $content->fieldtype === 'checkbox') {
            ...
            } else if ($content->fieldtype === 'textarea') {
